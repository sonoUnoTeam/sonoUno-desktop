...
class FrameDesign( wx.Frame ):
    ...
    def _createmenubar(self):
        ...
        self._ssminfreqmenuitem = wx.MenuItem(
            parentMenu = self._soundsubmenu,
            id = wx.ID_ANY,
        ...
        self._soundsubmenu.Append(self._ssminfreqmenuitem)
        self.Bind(
            event = wx.EVT_MENU,
            handler = self._eventssminfreqselect,
            id = self._ssminfreqmenuitem.GetId()
            )
        # Create max frequency menu item and append it to sound submenu
        self._ssmaxfreqmenuitem = wx.MenuItem(
            parentMenu = self._soundsubmenu,
            id = wx.ID_ANY,
            text = 'Maximum Frequency',
            helpString = ('Set the keyboard focus on maximum frequency slider '
                + 'text label.'),
            kind = wx.ITEM_NORMAL
            )
        self._soundsubmenu.Append(self._ssmaxfreqmenuitem)
        self.Bind(
            event = wx.EVT_MENU,
            handler = self._eventssmaxfreqselect,
            id = self._ssmaxfreqmenuitem.GetId()
            )
        ...
        self._ssspecialconfigmenuitem = wx.MenuItem(
            ...
            helpString = ('Set the keyboard focus on Special Sound Settings '
                + 'Panel.'),
            kind = wx.ITEM_NORMAL
            )
    ...
    #Crea el panel para desplegar las configuraciones de sonido y su sizer(row(8)col(1)) sin seccion expandida
        ...
        _soundFontFgSizer = wx.FlexGridSizer( 11, 1, 0, 0 )
        ...
        self._soundfreqmintextctrl = wx.TextCtrl( self._soundFontPanel, wx.ID_ANY, u"Min frequency:", wx.DefaultPosition, wx.Size( 90,15 ), style=wx.NO_BORDER|wx.TE_MULTILINE|wx.TE_NO_VSCROLL )
        self._soundfreqmintextctrl.SetEditable(0)
        _soundFontFgSizer.Add( self._soundfreqmintextctrl, 0, wx.ALL, 5 )
        #Crea la slider para la frecuencia
        self._soundfreqminslider = wx.Slider( self._soundFontPanel, wx.ID_ANY, 400, 0, 2900, wx.DefaultPosition, wx.DefaultSize, wx.SL_HORIZONTAL )
        ...
        _soundFontFgSizer.Add( self._soundfreqminslider, 0, wx.ALL|wx.EXPAND, 5 )
        ...
        self._minsoundfreqmintextctrl = wx.TextCtrl( self._soundFontPanel, wx.ID_ANY, u"100", wx.DefaultPosition, wx.Size( 50,15 ), style=wx.NO_BORDER|wx.TE_MULTILINE|wx.TE_NO_VSCROLL|wx.ALIGN_LEFT )
        ...
        self._actualsoundfreqmintextctrl = wx.TextCtrl( self._soundFontPanel, wx.ID_ANY, u"500", wx.DefaultPosition, wx.Size( 50,15 ), style=wx.NO_BORDER|wx.TE_MULTILINE|wx.TE_NO_VSCROLL|wx.ALIGN_LEFT )
        ...
        self._maxsoundfreqmintextctrl = wx.TextCtrl( self._soundFontPanel, wx.ID_ANY, u"3000", wx.DefaultPosition, wx.Size( 50,15 ), style=wx.NO_BORDER|wx.TE_MULTILINE|wx.TE_NO_VSCROLL|wx.ALIGN_RIGHT )
        ...
        _soundFontFgSizer.Add( _soundfreqminlabelsfgsizer, 1, wx.EXPAND, 5 )

        #Crea el espacio de texto con el label frecuencia max y lo agrega al sizer del panel de configuración de sonido
        self._soundfreqmaxtextctrl = wx.TextCtrl( self._soundFontPanel, wx.ID_ANY, u"Max frequency:", wx.DefaultPosition, wx.Size( 90,15 ), style=wx.NO_BORDER|wx.TE_MULTILINE|wx.TE_NO_VSCROLL )
        self._soundfreqmaxtextctrl.SetEditable(0)
        _soundFontFgSizer.Add( self._soundfreqmaxtextctrl, 0, wx.ALL, 5 )
        #Crea la slider para la frecuencia
        self._soundfreqmaxslider = wx.Slider( self._soundFontPanel, wx.ID_ANY, 2500, 0, 2500, wx.DefaultPosition, wx.DefaultSize, wx.SL_HORIZONTAL )
        ...
        _soundFontFgSizer.Add( self._soundfreqmaxslider, 0, wx.ALL|wx.EXPAND, 5 )
        #Crea el sizer para contener las etiquetas de la slider de frecuencia
        ...
        #Creo el primer label de la slider de freq
        self._minsoundfreqmaxtextctrl = wx.TextCtrl( self._soundFontPanel, wx.ID_ANY, u"500", wx.DefaultPosition, wx.Size( 50,15 ), style=wx.NO_BORDER|wx.TE_MULTILINE|wx.TE_NO_VSCROLL|wx.ALIGN_LEFT )
        ...
        #Creo el segundo label de la slider de freq
        self._actualsoundfreqmaxtextctrl = wx.TextCtrl( self._soundFontPanel, wx.ID_ANY, u"3000", wx.DefaultPosition, wx.Size( 50,15 ), style=wx.NO_BORDER|wx.TE_MULTILINE|wx.TE_NO_VSCROLL|wx.ALIGN_LEFT )
        ...
        #Creo el tercer label de la slider de freq
        self._maxsoundfreqmaxtextctrl = wx.TextCtrl( self._soundFontPanel, wx.ID_ANY, u"3000", wx.DefaultPosition, wx.Size( 50,15 ), style=wx.NO_BORDER|wx.TE_MULTILINE|wx.TE_NO_VSCROLL|wx.ALIGN_RIGHT )
        ...
        #Relaciona el sizer con el sizer del sonido
        _soundFontFgSizer.Add( _soundfreqmaxlabelsfgsizer, 1, wx.EXPAND, 5 )
...
#        _axisFgSizer.Add( _vAxisFgSizer, 1, wx.EXPAND, 5 )
    ...
    def _createInputDataDisplayPanel(self, panel):
        ...
        #Crea el panel y el sizer para la grilla.
        _gridboxfgsizer = wx.FlexGridSizer( 1, 3, 0, 0 )
...
#        event.Skip()
    ...
    def _eventssminfreqselect(self, event):
        event.Skip()

    def _eventssmaxfreqselect(self, event):
        event.Skip()
