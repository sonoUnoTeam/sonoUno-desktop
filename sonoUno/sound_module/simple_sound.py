...
class reproductorRaw (object):
    def __init__ (self, volume=0.5, min_freq = 500.0, max_freq = 5000.0, time_base = 0.25, duty_cycle = 1.0):
    ...
    def generate_waveform(self, freq, delta_t=0):
        ...
        if wf == 'piano':
            ...
            harmonics = [(1, 0.1884), (2, 0.0596), (3, 0.0473), (4, 0.0631),
                (5, 0.0018), (6, 0.0112), (7, 0.02), (8, 0.005), (9, 0.005),
    ...
    def pitch (self, value, cont):
        ...
        self.env = self._adsr_envelope()
        f = self.env*self.volume*2**15*self.generate_waveform(freq)
