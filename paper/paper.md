...
According to @wandatesis2013, sonification could enhance the actual data display, and, Casado et al. (2019, 2022) work reinforces that assumption. In addition, it was tested that astronomical datasets could be displayed in sonoUno in the same form as other visualization tools, with the benefit of sonification and allowing it to be used by people with different learning styles.
